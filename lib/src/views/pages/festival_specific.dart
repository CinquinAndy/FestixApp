...
class FestivalSpecific extends StatelessWidget {
  ...
  const FestivalSpecific(this.title, {Key? key, required this.backtitle}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MainPersonnalizedScafold(
      ...
      urlPhoto: "https://images.unsplash.com/photo-1599467556385-48b57868f038?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80",
      content: Column(
        children: [
          Expanded(
            child: Column(
